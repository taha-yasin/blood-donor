...
public class ExceptionHandlerController {
    ...
    public ErrorAttributes errorAttributes() {
        ...
        return new DefaultErrorAttributes() {
            ...
            public Map<String, Object> getErrorAttributes(WebRequest requestAttributes, ErrorAttributeOptions includeStackTrace) {
                ...
                errorAttributes.put("TAHA", "This is Exception");
    ...
    public void handleAccessDeniedException(AccessDeniedException ex, HttpServletResponse res) throws IOException {
        res.sendError(HttpStatus.FORBIDDEN.value(), "TAHA: Access denied");
    }
    ...
    public void handleInsufficientAuthenticationException(Exception ex, HttpServletResponse res) throws IOException {
        ...
        res.sendError(HttpStatus.FORBIDDEN.value(), "TAHA: Insufficient Authentication");
    }
    ...
    public void handleException(Exception ex, HttpServletResponse res) throws IOException {
        ...
        res.sendError(HttpStatus.INTERNAL_SERVER_ERROR.value(), "TAHA: Something went wrong");
    }
